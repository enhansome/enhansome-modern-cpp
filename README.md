...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,319 | 🐛 247 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [cmake\_template](https://github.com/cpp-best-practices/cmake_template) ⭐ 1,806 | 🐛 46 | 🌐 CMake | 📅 2026-08-17 - A template CMake project to get you started with C++ and tooling.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,541 | 🐛 478 | 🌐 C++ | 📅 2026-09-16 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,161 | 🐛 98 | 🌐 C++ | 📅 2026-09-16 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,545 | 🐛 506 | 🌐 C++ | 📅 2026-09-15 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,484 | 🐛 440 | 🌐 C++ | 📅 2026-09-14 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,866 | 🐛 140 | 🌐 C++ | 📅 2026-08-29 🚀 - The fastest feature-rich C++11/14/17/20 single-header testing framework for unit tests and TDD.
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,408 | 🐛 172 | 🌐 C++ | 📅 2026-09-15 🌟 - A microbenchmark support library.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,602 | 🐛 51 | 🌐 C++ | 📅 2026-09-05 - Fast C++ logging library.
...
* [SPSCQueue](https://github.com/rigtorp/SPSCQueue) ⭐ 1,288 | 🐛 12 | 🌐 C++ | 📅 2024-01-04 - A bounded single-producer single-consumer wait-free and lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,621 | 🐛 106 | 🌐 C++ | 📅 2026-09-16 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,256 | 🐛 139 | 🌐 C++ | 📅 2026-09-15 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,891 | 🐛 116 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,134 | 🐛 187 | 🌐 C++ | 📅 2026-09-08 - A YAML parser and emitter in C++.
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,708 | 🐛 345 | 🌐 C++ | 📅 2026-03-11 - A C++11 library for serialization.
* [cista](https://github.com/felixguendling/cista) ⭐ 2,253 | 🐛 11 | 🌐 C++ | 📅 2026-09-16 - A C++17 library for high-performance zero-copy binary serialization.
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,147 | 🐛 27 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 512 | 🐛 2 | 🌐 C++ | 📅 2026-09-10 - Fast, convenient JSON serialization and parsing in C++
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 95 | 🌐 C++ | 📅 2026-09-16 - A JSON library with robust support for custom allocators.
...
* [Inja](https://github.com/pantor/inja) ⭐ 1,971 | 🐛 56 | 🌐 C++ | 📅 2026-09-10 - A Template Engine for Modern C++.
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,008 | 🐛 728 | 🌐 C++ | 📅 2026-09-15 - Seamless operability between C++11 and Python.
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,140 | 🐛 308 | 🌐 C++ | 📅 2025-03-07 - C++ library binding to Lua.
* [ChaiScript](https://chaiscript.com/) - An easy to use embedded scripting language for C++.

### Web / HTTP

* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,281 | 🐛 430 | 🌐 C++ | 📅 2026-09-16 - A C++14/17 based, high-performance HTTP application framework
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,432 | 🐛 87 | 🌐 C++ | 📅 2026-09-06 - C++ Requests: Curl for People, a spiritual port of Python Requests.
* [Beast](https://github.com/boostorg/beast) ⭐ 4,823 | 🐛 103 | 🌐 C++ | 📅 2026-09-09 - HTTP and WebSocket built on Boost.Asio in C++11.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,695 | 🐛 16 | 🌐 C++ | 📅 2026-09-16 - powerful header only SQLite3 ORM library for C++14.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,107 | 🐛 2 | 🌐 C++ | 📅 2026-09-16 - C++ Driver for MongoDB.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,111 | 🐛 12 | 🌐 C++ | 📅 2026-09-16 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,200 | 🐛 16 | 🌐 C++ | 📅 2026-09-14 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
* [cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,808 | 🐛 70 | 🌐 C++ | 📅 2026-09-08 -  Lightweight C++ command line option parser.
* [range-v3](https://github.com/ericniebler/range-v3) ⭐ 4,375 | 🐛 286 | 🌐 C++ | 📅 2026-04-12 - Experimental range library for C++11/14/17.
* [date](https://github.com/HowardHinnant/date) ⭐ 3,432 | 🐛 179 | 🌐 C++ | 📅 2026-09-16 - A date and time library based on the C++11/14/17 <chrono> header.
* [indicators](https://github.com/p-ranav/indicators) ⭐ 3,412 | 🐛 50 | 🌐 C++ | 📅 2025-05-09 - Activity Indicators for Modern C++.
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,361 | 🐛 0 | 🌐 C++ | 📅 2026-08-28 - A header-only C++17 library provides nameof macros and functions to obtain the simple name of variable, type, function, macro, and enum.
* [tabulate](https://github.com/p-ranav/tabulate) ⭐ 2,176 | 🐛 44 | 🌐 C++ | 📅 2025-05-14 - Table Maker for Modern C++.
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,159 | 🐛 4 | 🌐 C++ | 📅 2026-08-17 - Parsing Expression Grammar Template Library (C++11, header-only).
...
* [tweeny](https://github.com/mobius3/tweeny) ⭐ 849 | 🐛 17 | 🌐 C++ | 📅 2026-08-03 - A header only interpolation library with 30+ easing functions.
...
* [ccls](https://github.com/MaskRay/ccls) ⭐ 4,089 | 🐛 193 | 🌐 C++ | 📅 2026-07-02 - C/C++/ObjC language server supporting cross references, hierarchies, completion and semantic highlighting, forked from cquery, which is under active development
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,482 | 🐛 548 | 🌐 C | 📅 2026-09-09 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,463 | 🐛 1,131 | 🌐 CMake | 📅 2026-09-16 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,127 | 🐛 168 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
