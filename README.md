...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,306 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [cmake\_template](https://github.com/cpp-best-practices/cmake_template) ⭐ 1,804 | 🐛 46 | 🌐 CMake | 📅 2026-08-17 - A template CMake project to get you started with C++ and tooling.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,534 | 🐛 472 | 🌐 C++ | 📅 2026-09-09 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,160 | 🐛 98 | 🌐 C++ | 📅 2026-09-09 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,507 | 🐛 503 | 🌐 C++ | 📅 2026-09-09 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,471 | 🐛 442 | 🌐 C++ | 📅 2026-09-09 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,391 | 🐛 176 | 🌐 C++ | 📅 2026-09-09 🌟 - A microbenchmark support library.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,586 | 🐛 47 | 🌐 C++ | 📅 2026-09-05 - Fast C++ logging library.
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,486 | 🐛 77 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,153 | 🐛 36 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [json](https://github.com/nlohmann/json) ⭐ 50,573 | 🐛 139 | 🌐 C++ | 📅 2026-09-09 🥇 - JSON for Modern C++.
...
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,130 | 🐛 182 | 🌐 C++ | 📅 2026-09-08 - A YAML parser and emitter in C++.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 511 | 🐛 1 | 🌐 C++ | 📅 2026-09-09 - Fast, convenient JSON serialization and parsing in C++
...
* [Inja](https://github.com/pantor/inja) ⭐ 1,968 | 🐛 55 | 🌐 C++ | 📅 2026-09-04 - A Template Engine for Modern C++.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,264 | 🐛 429 | 🌐 C++ | 📅 2026-09-09 - A C++14/17 based, high-performance HTTP application framework
...
* [Beast](https://github.com/boostorg/beast) ⭐ 4,821 | 🐛 103 | 🌐 C++ | 📅 2026-09-09 - HTTP and WebSocket built on Boost.Asio in C++11.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,693 | 🐛 17 | 🌐 C++ | 📅 2026-09-09 - powerful header only SQLite3 ORM library for C++14.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,108 | 🐛 2 | 🌐 C++ | 📅 2026-09-04 - C++ Driver for MongoDB.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,090 | 🐛 12 | 🌐 C++ | 📅 2026-09-02 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
...
* [range-v3](https://github.com/ericniebler/range-v3) ⭐ 4,375 | 🐛 287 | 🌐 C++ | 📅 2026-04-12 - Experimental range library for C++11/14/17.
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,470 | 🐛 548 | 🌐 C | 📅 2026-09-09 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,451 | 🐛 1,187 | 🌐 CMake | 📅 2026-09-09 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,119 | 🐛 167 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
