...
[please submit a pull request to the GitHub repository](https://github.com/rigtorp/awesome-modern-cpp) ⭐ 13,145 | 🐛 20 | 🌐 HTML | 📅 2024-08-20.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,292 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,526 | 🐛 465 | 🌐 C++ | 📅 2026-09-03 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,160 | 🐛 98 | 🌐 C++ | 📅 2026-09-03 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,486 | 🐛 500 | 🌐 C++ | 📅 2026-09-03 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,462 | 🐛 438 | 🌐 C++ | 📅 2026-09-03 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [rapidcheck](https://github.com/emil-e/rapidcheck) ⭐ 1,105 | 🐛 119 | 🌐 C++ | 📅 2026-08-06 - QuickCheck clone for C++.
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,383 | 🐛 175 | 🌐 C++ | 📅 2026-08-28 🌟 - A microbenchmark support library.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,568 | 🐛 51 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,477 | 🐛 77 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,140 | 🐛 34 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
* [concurrencpp](https://github.com/David-Haim/concurrencpp) ⭐ 2,765 | 🐛 13 | 🌐 C++ | 📅 2025-05-01 - A general concurrency library containing tasks, executors, timers and C++20 coroutines to rule them all.
...
* [SPSCQueue](https://github.com/rigtorp/SPSCQueue) ⭐ 1,285 | 🐛 11 | 🌐 C++ | 📅 2024-01-04 - A bounded single-producer single-consumer wait-free and lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,522 | 🐛 144 | 🌐 C++ | 📅 2026-09-03 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,235 | 🐛 132 | 🌐 C++ | 📅 2026-09-03 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,887 | 🐛 111 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 510 | 🐛 8 | 🌐 C++ | 📅 2026-09-03 - Fast, convenient JSON serialization and parsing in C++
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 479 | 🐛 93 | 🌐 C++ | 📅 2026-08-30 - A JSON library with robust support for custom allocators.
...
* [Inja](https://github.com/pantor/inja) ⭐ 1,966 | 🐛 56 | 🌐 C++ | 📅 2026-08-18 - A Template Engine for Modern C++.
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,010 | 🐛 725 | 🌐 C++ | 📅 2026-09-01 - Seamless operability between C++11 and Python.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,240 | 🐛 425 | 🌐 C++ | 📅 2026-09-03 - A C++14/17 based, high-performance HTTP application framework
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,651 | 🐛 348 | 🌐 C++ | 📅 2025-11-12 - High-performance Web framework (C++11, zero-dependency).
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,424 | 🐛 87 | 🌐 C++ | 📅 2026-08-28 - C++ Requests: Curl for People, a spiritual port of Python Requests.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,694 | 🐛 15 | 🌐 C++ | 📅 2026-09-03 - powerful header only SQLite3 ORM library for C++14.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,106 | 🐛 4 | 🌐 C++ | 📅 2026-09-03 - C++ Driver for MongoDB.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,078 | 🐛 11 | 🌐 C++ | 📅 2026-09-02 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,181 | 🐛 16 | 🌐 C++ | 📅 2026-09-02 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
* [cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,806 | 🐛 71 | 🌐 C++ | 📅 2026-09-03 -  Lightweight C++ command line option parser.
...
* [ccls](https://github.com/MaskRay/ccls) ⭐ 4,086 | 🐛 193 | 🌐 C++ | 📅 2026-07-02 - C/C++/ObjC language server supporting cross references, hierarchies, completion and semantic highlighting, forked from cquery, which is under active development
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,465 | 🐛 549 | 🌐 C | 📅 2026-05-19 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,432 | 🐛 1,185 | 🌐 CMake | 📅 2026-09-03 - C++ Library Manager for Windows, Linux, and MacOS
