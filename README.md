...
[please submit a pull request to the GitHub repository](https://github.com/rigtorp/awesome-modern-cpp) ⭐ 13,159 | 🐛 20 | 🌐 HTML | 📅 2024-08-20.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,318 | 🐛 247 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,402 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for kick-starting modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management and more.
* [modern-cpp-template](https://github.com/filipdutescu/modern-cpp-template) ⭐ 1,920 | 🐛 12 | 🌐 CMake | 📅 2025-12-26 - A template for modern C++ projects using CMake, Clang-Format, CI, unit testing and more, with support for downstream inclusion.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,541 | 🐛 478 | 🌐 C++ | 📅 2026-09-15 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,161 | 🐛 98 | 🌐 C++ | 📅 2026-09-15 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,538 | 🐛 506 | 🌐 C++ | 📅 2026-09-15 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,477 | 🐛 440 | 🌐 C++ | 📅 2026-09-14 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,403 | 🐛 173 | 🌐 C++ | 📅 2026-09-15 🌟 - A microbenchmark support library.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,604 | 🐛 50 | 🌐 C++ | 📅 2026-09-05 - Fast C++ logging library.
* [loguru](https://github.com/emilk/loguru) ⭐ 1,911 | 🐛 71 | 🌐 C++ | 📅 2026-09-10 - A lightweight and flexible C++ logging library
...
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,168 | 🐛 36 | 🌐 C++ | 📅 2026-09-14 - Modern C++ Parallel Task Programming Library
...
* [json](https://github.com/nlohmann/json) ⭐ 50,613 | 🐛 119 | 🌐 C++ | 📅 2026-09-15 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,253 | 🐛 139 | 🌐 C++ | 📅 2026-09-15 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,890 | 🐛 116 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,133 | 🐛 187 | 🌐 C++ | 📅 2026-09-08 - A YAML parser and emitter in C++.
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,146 | 🐛 27 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 94 | 🌐 C++ | 📅 2026-09-11 - A JSON library with robust support for custom allocators.
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,006 | 🐛 728 | 🌐 C++ | 📅 2026-09-15 - Seamless operability between C++11 and Python.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,276 | 🐛 432 | 🌐 C++ | 📅 2026-09-14 - A C++14/17 based, high-performance HTTP application framework
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,652 | 🐛 350 | 🌐 C++ | 📅 2025-11-12 - High-performance Web framework (C++11, zero-dependency).
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,695 | 🐛 17 | 🌐 C++ | 📅 2026-09-15 - powerful header only SQLite3 ORM library for C++14.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,107 | 🐛 2 | 🌐 C++ | 📅 2026-09-15 - C++ Driver for MongoDB.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,109 | 🐛 12 | 🌐 C++ | 📅 2026-09-02 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,198 | 🐛 16 | 🌐 C++ | 📅 2026-09-14 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
...
* [tabulate](https://github.com/p-ranav/tabulate) ⭐ 2,176 | 🐛 44 | 🌐 C++ | 📅 2025-05-14 - Table Maker for Modern C++.
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,158 | 🐛 4 | 🌐 C++ | 📅 2026-08-17 - Parsing Expression Grammar Template Library (C++11, header-only).
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,481 | 🐛 548 | 🌐 C | 📅 2026-09-09 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,462 | 🐛 1,122 | 🌐 CMake | 📅 2026-09-15 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,125 | 🐛 167 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
