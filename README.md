...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,264 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,508 | 🐛 462 | 🌐 C++ | 📅 2026-08-24 - Facebook Open-source Library.
...
* [Googletest](https://github.com/google/googletest) ⭐ 38,957 | 🐛 493 | 🌐 C++ | 📅 2026-08-21 - Google Testing and Mocking Framework.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,520 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,453 | 🐛 101 | 🌐 C++ | 📅 2026-08-21 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,181 | 🐛 137 | 🌐 C++ | 📅 2026-08-23 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
...
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 91 | 🌐 C++ | 📅 2026-08-24 - A JSON library with robust support for custom allocators.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,204 | 🐛 429 | 🌐 C++ | 📅 2026-08-24 - A C++14/17 based, high-performance HTTP application framework
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,642 | 🐛 347 | 🌐 C++ | 📅 2025-11-12 - High-performance Web framework (C++11, zero-dependency).
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,413 | 🐛 87 | 🌐 C++ | 📅 2026-07-26 - C++ Requests: Curl for People, a spiritual port of Python Requests.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,045 | 🐛 11 | 🌐 C++ | 📅 2026-08-09 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,390 | 🐛 1,194 | 🌐 CMake | 📅 2026-08-24 - C++ Library Manager for Windows, Linux, and MacOS
