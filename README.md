...
[please submit a pull request to the GitHub repository](https://github.com/rigtorp/awesome-modern-cpp) ⭐ 13,126 | 🐛 20 | 🌐 HTML | 📅 2024-08-20.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,491 | 🐛 459 | 🌐 C++ | 📅 2026-08-14 - Facebook Open-source Library.
...
* [Googletest](https://github.com/google/googletest) ⭐ 38,927 | 🐛 490 | 🌐 C++ | 📅 2026-08-13 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,427 | 🐛 442 | 🌐 C++ | 📅 2026-08-10 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [nanobench](https://github.com/martinus/nanobench) ⭐ 1,727 | 🐛 3 | 🌐 C++ | 📅 2026-08-14 - Simple, fast, accurate single-header microbenchmarking functionality for C++11/14/17/20
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,480 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
...
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,108 | 🐛 33 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [json](https://github.com/nlohmann/json) ⭐ 50,371 | 🐛 100 | 🌐 C++ | 📅 2026-08-13 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,148 | 🐛 135 | 🌐 C++ | 📅 2026-08-14 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,880 | 🐛 112 | 🌐 C++ | 📅 2026-07-29 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,121 | 🐛 183 | 🌐 C++ | 📅 2026-08-14 - A YAML parser and emitter in C++.
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,701 | 🐛 343 | 🌐 C++ | 📅 2026-03-11 - A C++11 library for serialization.
* [cista](https://github.com/felixguendling/cista) ⭐ 2,237 | 🐛 12 | 🌐 C++ | 📅 2026-07-16 - A C++17 library for high-performance zero-copy binary serialization.
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,122 | 🐛 26 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,995 | 🐛 714 | 🌐 C++ | 📅 2026-08-14 - Seamless operability between C++11 and Python.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,184 | 🐛 422 | 🌐 C++ | 📅 2026-08-11 - A C++14/17 based, high-performance HTTP application framework
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,689 | 🐛 19 | 🌐 C++ | 📅 2026-08-14 - powerful header only SQLite3 ORM library for C++14.
* [sqlpp11](https://github.com/rbock/sqlpp11) ⭐ 2,625 | 🐛 3 | 🌐 C++ | 📅 2026-04-24 - A type safe SQL template library for C++.
* [libpqxx](https://github.com/jtv/libpqxx) ⭐ 1,343 | 🐛 7 | 🌐 C++ | 📅 2026-08-03 - The official C++ client API for PostgreSQL.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,012 | 🐛 11 | 🌐 C++ | 📅 2026-08-09 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,166 | 🐛 19 | 🌐 C++ | 📅 2026-08-11 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,357 | 🐛 1,179 | 🌐 CMake | 📅 2026-08-14 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,091 | 🐛 164 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
