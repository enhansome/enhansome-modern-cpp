...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,258 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [modern-cpp-template](https://github.com/filipdutescu/modern-cpp-template) ⭐ 1,916 | 🐛 12 | 🌐 CMake | 📅 2025-12-26 - A template for modern C++ projects using CMake, Clang-Format, CI, unit testing and more, with support for downstream inclusion.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,506 | 🐛 462 | 🌐 C++ | 📅 2026-08-22 - Facebook Open-source Library.
...
* [Googletest](https://github.com/google/googletest) ⭐ 38,953 | 🐛 493 | 🌐 C++ | 📅 2026-08-21 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,434 | 🐛 438 | 🌐 C++ | 📅 2026-08-22 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,362 | 🐛 176 | 🌐 C++ | 📅 2026-08-18 🌟 - A microbenchmark support library.
* [nanobench](https://github.com/martinus/nanobench) ⭐ 1,728 | 🐛 0 | 🌐 C++ | 📅 2026-08-22 - Simple, fast, accurate single-header microbenchmarking functionality for C++11/14/17/20
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,513 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
...
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,122 | 🐛 33 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [MPMCQueue](https://github.com/rigtorp/MPMCQueue) ⭐ 1,563 | 🐛 13 | 🌐 C++ | 📅 2024-03-08 - A bounded multi-producer multi-consumer lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,435 | 🐛 101 | 🌐 C++ | 📅 2026-08-21 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,171 | 🐛 137 | 🌐 C++ | 📅 2026-08-20 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,885 | 🐛 110 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,131 | 🐛 185 | 🌐 C++ | 📅 2026-08-14 - A YAML parser and emitter in C++.
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,701 | 🐛 343 | 🌐 C++ | 📅 2026-03-11 - A C++11 library for serialization.
* [cista](https://github.com/felixguendling/cista) ⭐ 2,239 | 🐛 11 | 🌐 C++ | 📅 2026-08-15 - A C++17 library for high-performance zero-copy binary serialization.
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,129 | 🐛 28 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 92 | 🌐 C++ | 📅 2026-08-22 - A JSON library with robust support for custom allocators.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,201 | 🐛 427 | 🌐 C++ | 📅 2026-08-20 - A C++14/17 based, high-performance HTTP application framework
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,411 | 🐛 87 | 🌐 C++ | 📅 2026-07-26 - C++ Requests: Curl for People, a spiritual port of Python Requests.
...
* [SeqAn](https://github.com/seqan/seqan3.git) ⭐ 460 | 🐛 34 | 🌐 C++ | 📅 2026-08-22 - The modern C++ library for sequence analysis (C++17, C++20).

### Misc

* [EnTT](https://github.com/skypjack/entt) ⭐ 13,032 | 🐛 11 | 🌐 C++ | 📅 2026-08-09 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,175 | 🐛 16 | 🌐 C++ | 📅 2026-08-11 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
...
* [date](https://github.com/HowardHinnant/date) ⭐ 3,430 | 🐛 179 | 🌐 C++ | 📅 2026-08-20 - A date and time library based on the C++11/14/17 <chrono> header.
* [indicators](https://github.com/p-ranav/indicators) ⭐ 3,409 | 🐛 49 | 🌐 C++ | 📅 2025-05-09 - Activity Indicators for Modern C++.
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,356 | 🐛 0 | 🌐 C++ | 📅 2026-08-05 - A header-only C++17 library provides nameof macros and functions to obtain the simple name of variable, type, function, macro, and enum.
...
* [ccls](https://github.com/MaskRay/ccls) ⭐ 4,080 | 🐛 193 | 🌐 C++ | 📅 2026-07-02 - C/C++/ObjC language server supporting cross references, hierarchies, completion and semantic highlighting, forked from cquery, which is under active development
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,384 | 🐛 1,150 | 🌐 CMake | 📅 2026-08-22 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,101 | 🐛 164 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
...
* [Hunter](https://github.com/cpp-pm/hunter) ⭐ 674 | 🐛 35 | 🌐 CMake | 📅 2026-08-21 - Cross-platform package manager for C++.
