...
[please submit a pull request to the GitHub repository](https://github.com/rigtorp/awesome-modern-cpp) ⭐ 13,143 | 🐛 20 | 🌐 HTML | 📅 2024-08-20.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,291 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,395 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for kick-starting modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management and more.
* [modern-cpp-template](https://github.com/filipdutescu/modern-cpp-template) ⭐ 1,918 | 🐛 12 | 🌐 CMake | 📅 2025-12-26 - A template for modern C++ projects using CMake, Clang-Format, CI, unit testing and more, with support for downstream inclusion.
* [cmake\_template](https://github.com/cpp-best-practices/cmake_template) ⭐ 1,805 | 🐛 46 | 🌐 CMake | 📅 2026-08-17 - A template CMake project to get you started with C++ and tooling.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,524 | 🐛 465 | 🌐 C++ | 📅 2026-08-31 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,160 | 🐛 98 | 🌐 C++ | 📅 2026-08-31 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,407 | 🐛 496 | 🌐 C++ | 📅 2026-08-31 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,455 | 🐛 438 | 🌐 C++ | 📅 2026-08-25 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,857 | 🐛 138 | 🌐 C++ | 📅 2026-08-29 🚀 - The fastest feature-rich C++11/14/17/20 single-header testing framework for unit tests and TDD.
...
* [Mull](https://github.com/mull-project/mull) ⭐ 835 | 🐛 23 | 🌐 C++ | 📅 2026-07-31 - Practical mutation testing tool for C and C++
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,376 | 🐛 174 | 🌐 C++ | 📅 2026-08-28 🌟 - A microbenchmark support library.
* [nanobench](https://github.com/martinus/nanobench) ⭐ 1,733 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 - Simple, fast, accurate single-header microbenchmarking functionality for C++11/14/17/20
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,556 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
* [loguru](https://github.com/emilk/loguru) ⭐ 1,908 | 🐛 92 | 🌐 C++ | 📅 2026-07-31 - A lightweight and flexible C++ logging library
* [fmtlog](https://github.com/MengRao/fmtlog) ⭐ 1,025 | 🐛 40 | 🌐 C++ | 📅 2025-02-13 - A fmtlib-style logging library with latency in nanoseconds.
...
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,135 | 🐛 34 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
* [concurrencpp](https://github.com/David-Haim/concurrencpp) ⭐ 2,763 | 🐛 13 | 🌐 C++ | 📅 2025-05-01 - A general concurrency library containing tasks, executors, timers and C++20 coroutines to rule them all.
* [MPMCQueue](https://github.com/rigtorp/MPMCQueue) ⭐ 1,564 | 🐛 13 | 🌐 C++ | 📅 2024-03-08 - A bounded multi-producer multi-consumer lock-free queue written in C++11.
* [Junction](https://github.com/preshing/junction) ⭐ 1,461 | 🐛 17 | 🌐 C++ | 📅 2026-05-16 - Concurrent data structures in C++.
* [SPSCQueue](https://github.com/rigtorp/SPSCQueue) ⭐ 1,283 | 🐛 11 | 🌐 C++ | 📅 2024-01-04 - A bounded single-producer single-consumer wait-free and lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,492 | 🐛 140 | 🌐 C++ | 📅 2026-08-31 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,217 | 🐛 134 | 🌐 C++ | 📅 2026-08-31 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,887 | 🐛 110 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,138 | 🐛 182 | 🌐 C++ | 📅 2026-08-24 - A YAML parser and emitter in C++.
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,705 | 🐛 344 | 🌐 C++ | 📅 2026-03-11 - A C++11 library for serialization.
* [cista](https://github.com/felixguendling/cista) ⭐ 2,247 | 🐛 11 | 🌐 C++ | 📅 2026-08-31 - A C++17 library for high-performance zero-copy binary serialization.
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,137 | 🐛 28 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 510 | 🐛 15 | 🌐 C++ | 📅 2026-08-30 - Fast, convenient JSON serialization and parsing in C++
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 93 | 🌐 C++ | 📅 2026-08-30 - A JSON library with robust support for custom allocators.
* [json\_struct](https://github.com/jorgen/json_struct) ⭐ 473 | 🐛 3 | 🌐 C++ | 📅 2026-08-29 - High performance, single header JSON parser, parsing directly to and from C++ structs.
...
* [Inja](https://github.com/pantor/inja) ⭐ 1,964 | 🐛 55 | 🌐 C++ | 📅 2026-08-18 - A Template Engine for Modern C++.
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,009 | 🐛 713 | 🌐 C++ | 📅 2026-08-31 - Seamless operability between C++11 and Python.
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,133 | 🐛 308 | 🌐 C++ | 📅 2025-03-07 - C++ library binding to Lua.
* [ChaiScript](https://chaiscript.com/) - An easy to use embedded scripting language for C++.

### Web / HTTP

* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,223 | 🐛 422 | 🌐 C++ | 📅 2026-08-27 - A C++14/17 based, high-performance HTTP application framework
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,648 | 🐛 348 | 🌐 C++ | 📅 2025-11-12 - High-performance Web framework (C++11, zero-dependency).
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,425 | 🐛 86 | 🌐 C++ | 📅 2026-08-28 - C++ Requests: Curl for People, a spiritual port of Python Requests.
* [Beast](https://github.com/boostorg/beast) ⭐ 4,821 | 🐛 106 | 🌐 C++ | 📅 2026-08-25 - HTTP and WebSocket built on Boost.Asio in C++11.
* [restbed](https://github.com/Corvusoft/restbed) ⭐ 1,999 | 🐛 4 | 🌐 C++ | 📅 2026-06-23 - Restbed framework brings asynchronous RESTful functionality to C++11 applications.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,692 | 🐛 15 | 🌐 C++ | 📅 2026-08-31 - powerful header only SQLite3 ORM library for C++14.
* [sqlpp11](https://github.com/rbock/sqlpp11) ⭐ 2,624 | 🐛 3 | 🌐 C++ | 📅 2026-04-24 - A type safe SQL template library for C++.
* [libpqxx](https://github.com/jtv/libpqxx) ⭐ 1,350 | 🐛 7 | 🌐 C++ | 📅 2026-08-03 - The official C++ client API for PostgreSQL.
...
* [SeqAn](https://github.com/seqan/seqan3.git) ⭐ 461 | 🐛 33 | 🌐 C++ | 📅 2026-08-31 - The modern C++ library for sequence analysis (C++17, C++20).

### Misc

* [EnTT](https://github.com/skypjack/entt) ⭐ 13,069 | 🐛 11 | 🌐 C++ | 📅 2026-08-31 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,179 | 🐛 16 | 🌐 C++ | 📅 2026-08-31 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
* [cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,803 | 🐛 70 | 🌐 C++ | 📅 2026-07-13 -  Lightweight C++ command line option parser.
* [range-v3](https://github.com/ericniebler/range-v3) ⭐ 4,377 | 🐛 286 | 🌐 C++ | 📅 2026-04-12 - Experimental range library for C++11/14/17.
* [date](https://github.com/HowardHinnant/date) ⭐ 3,432 | 🐛 179 | 🌐 C++ | 📅 2026-08-27 - A date and time library based on the C++11/14/17 <chrono> header.
* [indicators](https://github.com/p-ranav/indicators) ⭐ 3,410 | 🐛 49 | 🌐 C++ | 📅 2025-05-09 - Activity Indicators for Modern C++.
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,357 | 🐛 0 | 🌐 C++ | 📅 2026-08-28 - A header-only C++17 library provides nameof macros and functions to obtain the simple name of variable, type, function, macro, and enum.
* [tabulate](https://github.com/p-ranav/tabulate) ⭐ 2,174 | 🐛 44 | 🌐 C++ | 📅 2025-05-14 - Table Maker for Modern C++.
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,154 | 🐛 5 | 🌐 C++ | 📅 2026-08-17 - Parsing Expression Grammar Template Library (C++11, header-only).
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,457 | 🐛 549 | 🌐 C | 📅 2026-05-19 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,415 | 🐛 1,175 | 🌐 CMake | 📅 2026-08-31 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,109 | 🐛 167 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
...
* [Hunter](https://github.com/cpp-pm/hunter) ⭐ 673 | 🐛 35 | 🌐 CMake | 📅 2026-08-27 - Cross-platform package manager for C++.
