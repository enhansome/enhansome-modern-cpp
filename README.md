...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,308 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,535 | 🐛 472 | 🌐 C++ | 📅 2026-09-10 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,161 | 🐛 98 | 🌐 C++ | 📅 2026-09-09 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,507 | 🐛 505 | 🌐 C++ | 📅 2026-09-10 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,471 | 🐛 442 | 🌐 C++ | 📅 2026-09-10 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [Mull](https://github.com/mull-project/mull) ⭐ 836 | 🐛 25 | 🌐 C++ | 📅 2026-07-31 - Practical mutation testing tool for C and C++
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,393 | 🐛 178 | 🌐 C++ | 📅 2026-09-10 🌟 - A microbenchmark support library.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,587 | 🐛 47 | 🌐 C++ | 📅 2026-09-05 - Fast C++ logging library.
* [loguru](https://github.com/emilk/loguru) ⭐ 1,909 | 🐛 70 | 🌐 C++ | 📅 2026-09-10 - A lightweight and flexible C++ logging library
* [fmtlog](https://github.com/MengRao/fmtlog) ⭐ 1,026 | 🐛 40 | 🌐 C++ | 📅 2025-02-13 - A fmtlib-style logging library with latency in nanoseconds.

### Threading

* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,487 | 🐛 77 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,156 | 🐛 36 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [MPMCQueue](https://github.com/rigtorp/MPMCQueue) ⭐ 1,565 | 🐛 13 | 🌐 C++ | 📅 2024-03-08 - A bounded multi-producer multi-consumer lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,579 | 🐛 136 | 🌐 C++ | 📅 2026-09-10 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,246 | 🐛 135 | 🌐 C++ | 📅 2026-09-07 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,889 | 🐛 115 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,131 | 🐛 182 | 🌐 C++ | 📅 2026-09-08 - A YAML parser and emitter in C++.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 511 | 🐛 1 | 🌐 C++ | 📅 2026-09-10 - Fast, convenient JSON serialization and parsing in C++
...
* [json\_struct](https://github.com/jorgen/json_struct) ⭐ 473 | 🐛 4 | 🌐 C++ | 📅 2026-08-29 - High performance, single header JSON parser, parsing directly to and from C++ structs.
...
* [Inja](https://github.com/pantor/inja) ⭐ 1,969 | 🐛 55 | 🌐 C++ | 📅 2026-09-10 - A Template Engine for Modern C++.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,265 | 🐛 429 | 🌐 C++ | 📅 2026-09-09 - A C++14/17 based, high-performance HTTP application framework
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,657 | 🐛 349 | 🌐 C++ | 📅 2025-11-12 - High-performance Web framework (C++11, zero-dependency).
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,427 | 🐛 87 | 🌐 C++ | 📅 2026-09-06 - C++ Requests: Curl for People, a spiritual port of Python Requests.
* [Beast](https://github.com/boostorg/beast) ⭐ 4,820 | 🐛 103 | 🌐 C++ | 📅 2026-09-09 - HTTP and WebSocket built on Boost.Asio in C++11.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,693 | 🐛 17 | 🌐 C++ | 📅 2026-09-10 - powerful header only SQLite3 ORM library for C++14.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,108 | 🐛 3 | 🌐 C++ | 📅 2026-09-10 - C++ Driver for MongoDB.
...
* [SeqAn](https://github.com/seqan/seqan3.git) ⭐ 462 | 🐛 33 | 🌐 C++ | 📅 2026-09-06 - The modern C++ library for sequence analysis (C++17, C++20).

### Misc

* [EnTT](https://github.com/skypjack/entt) ⭐ 13,094 | 🐛 12 | 🌐 C++ | 📅 2026-09-02 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,188 | 🐛 16 | 🌐 C++ | 📅 2026-09-02 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
...
* [indicators](https://github.com/p-ranav/indicators) ⭐ 3,411 | 🐛 49 | 🌐 C++ | 📅 2025-05-09 - Activity Indicators for Modern C++.
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,360 | 🐛 0 | 🌐 C++ | 📅 2026-08-28 - A header-only C++17 library provides nameof macros and functions to obtain the simple name of variable, type, function, macro, and enum.
...
* [tweeny](https://github.com/mobius3/tweeny) ⭐ 848 | 🐛 17 | 🌐 C++ | 📅 2026-08-03 - A header only interpolation library with 30+ easing functions.
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,472 | 🐛 548 | 🌐 C | 📅 2026-09-09 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,456 | 🐛 1,159 | 🌐 CMake | 📅 2026-09-10 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,120 | 🐛 167 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
