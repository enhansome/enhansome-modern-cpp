...
* [cmake\_template](https://github.com/cpp-best-practices/cmake_template) ⭐ 1,801 | 🐛 44 | 🌐 CMake | 📅 2026-08-17 - A template CMake project to get you started with C++ and tooling.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,507 | 🐛 462 | 🌐 C++ | 📅 2026-08-24 - Facebook Open-source Library.
...
* [Googletest](https://github.com/google/googletest) ⭐ 38,956 | 🐛 493 | 🌐 C++ | 📅 2026-08-21 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,437 | 🐛 438 | 🌐 C++ | 📅 2026-08-24 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,462 | 🐛 76 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,454 | 🐛 101 | 🌐 C++ | 📅 2026-08-21 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,181 | 🐛 135 | 🌐 C++ | 📅 2026-08-24 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,884 | 🐛 110 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,135 | 🐛 181 | 🌐 C++ | 📅 2026-08-24 - A YAML parser and emitter in C++.
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,702 | 🐛 343 | 🌐 C++ | 📅 2026-03-11 - A C++11 library for serialization.
* [cista](https://github.com/felixguendling/cista) ⭐ 2,241 | 🐛 11 | 🌐 C++ | 📅 2026-08-15 - A C++17 library for high-performance zero-copy binary serialization.
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,131 | 🐛 28 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,004 | 🐛 713 | 🌐 C++ | 📅 2026-08-23 - Seamless operability between C++11 and Python.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,205 | 🐛 429 | 🌐 C++ | 📅 2026-08-24 - A C++14/17 based, high-performance HTTP application framework
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,414 | 🐛 87 | 🌐 C++ | 📅 2026-07-26 - C++ Requests: Curl for People, a spiritual port of Python Requests.
* [Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 107 | 🌐 C++ | 📅 2026-08-12 - HTTP and WebSocket built on Boost.Asio in C++11.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,105 | 🐛 2 | 🌐 C++ | 📅 2026-08-20 - C++ Driver for MongoDB.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,045 | 🐛 11 | 🌐 C++ | 📅 2026-08-24 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
...
* [ccls](https://github.com/MaskRay/ccls) ⭐ 4,081 | 🐛 193 | 🌐 C++ | 📅 2026-07-02 - C/C++/ObjC language server supporting cross references, hierarchies, completion and semantic highlighting, forked from cquery, which is under active development
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,453 | 🐛 549 | 🌐 C | 📅 2026-05-19 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,391 | 🐛 1,185 | 🌐 CMake | 📅 2026-08-24 - C++ Library Manager for Windows, Linux, and MacOS
