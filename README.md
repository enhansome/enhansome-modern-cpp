...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,257 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [cmake\_template](https://github.com/cpp-best-practices/cmake_template) ⭐ 1,799 | 🐛 44 | 🌐 CMake | 📅 2026-08-17 - A template CMake project to get you started with C++ and tooling.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,506 | 🐛 463 | 🌐 C++ | 📅 2026-08-21 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,159 | 🐛 98 | 🌐 C++ | 📅 2026-08-21 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 38,951 | 🐛 495 | 🌐 C++ | 📅 2026-08-19 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,431 | 🐛 438 | 🌐 C++ | 📅 2026-08-20 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,360 | 🐛 175 | 🌐 C++ | 📅 2026-08-18 🌟 - A microbenchmark support library.
* [nanobench](https://github.com/martinus/nanobench) ⭐ 1,728 | 🐛 0 | 🌐 C++ | 📅 2026-08-19 - Simple, fast, accurate single-header microbenchmarking functionality for C++11/14/17/20
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,512 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
* [loguru](https://github.com/emilk/loguru) ⭐ 1,907 | 🐛 92 | 🌐 C++ | 📅 2026-07-31 - A lightweight and flexible C++ logging library
* [fmtlog](https://github.com/MengRao/fmtlog) ⭐ 1,025 | 🐛 39 | 🌐 C++ | 📅 2025-02-13 - A fmtlib-style logging library with latency in nanoseconds.

### Threading

* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,458 | 🐛 76 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,121 | 🐛 33 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [SPSCQueue](https://github.com/rigtorp/SPSCQueue) ⭐ 1,279 | 🐛 11 | 🌐 C++ | 📅 2024-01-04 - A bounded single-producer single-consumer wait-free and lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,420 | 🐛 101 | 🌐 C++ | 📅 2026-08-21 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,167 | 🐛 135 | 🌐 C++ | 📅 2026-08-20 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
* [jsoncpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,885 | 🐛 110 | 🌐 C++ | 📅 2026-08-20 - A C++ library for interacting with JSON.
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 6,131 | 🐛 183 | 🌐 C++ | 📅 2026-08-14 - A YAML parser and emitter in C++.
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,701 | 🐛 343 | 🌐 C++ | 📅 2026-03-11 - A C++11 library for serialization.
* [cista](https://github.com/felixguendling/cista) ⭐ 2,238 | 🐛 11 | 🌐 C++ | 📅 2026-08-15 - A C++17 library for high-performance zero-copy binary serialization.
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,126 | 🐛 28 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 510 | 🐛 15 | 🌐 C++ | 📅 2026-08-21 - Fast, convenient JSON serialization and parsing in C++
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 117 | 🌐 C++ | 📅 2026-08-19 - A JSON library with robust support for custom allocators.
* [json\_struct](https://github.com/jorgen/json_struct) ⭐ 473 | 🐛 6 | 🌐 C++ | 📅 2026-07-04 - High performance, single header JSON parser, parsing directly to and from C++ structs.
...
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,127 | 🐛 308 | 🌐 C++ | 📅 2025-03-07 - C++ library binding to Lua.
* [ChaiScript](https://chaiscript.com/) - An easy to use embedded scripting language for C++.

### Web / HTTP

* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,200 | 🐛 427 | 🌐 C++ | 📅 2026-08-20 - A C++14/17 based, high-performance HTTP application framework
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,410 | 🐛 87 | 🌐 C++ | 📅 2026-07-26 - C++ Requests: Curl for People, a spiritual port of Python Requests.
* [Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 106 | 🌐 C++ | 📅 2026-08-12 - HTTP and WebSocket built on Boost.Asio in C++11.
* [restbed](https://github.com/Corvusoft/restbed) ⭐ 2,000 | 🐛 4 | 🌐 C++ | 📅 2026-06-23 - Restbed framework brings asynchronous RESTful functionality to C++11 applications.
...
* [libpqxx](https://github.com/jtv/libpqxx) ⭐ 1,347 | 🐛 7 | 🌐 C++ | 📅 2026-08-03 - The official C++ client API for PostgreSQL.
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,105 | 🐛 3 | 🌐 C++ | 📅 2026-08-20 - C++ Driver for MongoDB.
...
* [TinyORM](https://github.com/silverqx/TinyORM) ⭐ 352 | 🐛 15 | 🌐 C++ | 📅 2025-04-02 - Modern C++ ORM library.

### BioC++

* [SeqAn](https://github.com/seqan/seqan3.git) ⭐ 460 | 🐛 34 | 🌐 C++ | 📅 2026-08-17 - The modern C++ library for sequence analysis (C++17, C++20).

### Misc

* [EnTT](https://github.com/skypjack/entt) ⭐ 13,030 | 🐛 11 | 🌐 C++ | 📅 2026-08-09 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,174 | 🐛 16 | 🌐 C++ | 📅 2026-08-11 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
* [cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,798 | 🐛 70 | 🌐 C++ | 📅 2026-07-13 -  Lightweight C++ command line option parser.
* [range-v3](https://github.com/ericniebler/range-v3) ⭐ 4,375 | 🐛 286 | 🌐 C++ | 📅 2026-04-12 - Experimental range library for C++11/14/17.
* [date](https://github.com/HowardHinnant/date) ⭐ 3,429 | 🐛 179 | 🌐 C++ | 📅 2026-08-20 - A date and time library based on the C++11/14/17 <chrono> header.
* [indicators](https://github.com/p-ranav/indicators) ⭐ 3,409 | 🐛 49 | 🌐 C++ | 📅 2025-05-09 - Activity Indicators for Modern C++.
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,354 | 🐛 0 | 🌐 C++ | 📅 2026-08-05 - A header-only C++17 library provides nameof macros and functions to obtain the simple name of variable, type, function, macro, and enum.
* [tabulate](https://github.com/p-ranav/tabulate) ⭐ 2,172 | 🐛 44 | 🌐 C++ | 📅 2025-05-14 - Table Maker for Modern C++.
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,149 | 🐛 5 | 🌐 C++ | 📅 2026-08-17 - Parsing Expression Grammar Template Library (C++11, header-only).
...
* [Vireo](https://github.com/twitter/vireo) ⭐ 955 | 🐛 15 | 🌐 C++ | 📅 2021-10-21 - A lightweight and versatile video processing library by Twitter.
* [random](https://github.com/effolkronium/random) ⭐ 947 | 🐛 0 | 🌐 C++ | 📅 2026-02-16 - A simple, convenient, header only Random for modern C++.
* [tweeny](https://github.com/mobius3/tweeny) ⭐ 846 | 🐛 17 | 🌐 C++ | 📅 2026-08-03 - A header only interpolation library with 30+ easing functions.
...
* [ccls](https://github.com/MaskRay/ccls) ⭐ 4,079 | 🐛 193 | 🌐 C++ | 📅 2026-07-02 - C/C++/ObjC language server supporting cross references, hierarchies, completion and semantic highlighting, forked from cquery, which is under active development
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,382 | 🐛 1,147 | 🌐 CMake | 📅 2026-08-21 - C++ Library Manager for Windows, Linux, and MacOS
* [CPM](https://github.com/TheLartians/CPM) ⭐ 4,099 | 🐛 164 | 🌐 CMake | 📅 2026-07-06 - A CMake script for setup-free cross-plattform dependency management.
...
* [Hunter](https://github.com/cpp-pm/hunter) ⭐ 674 | 🐛 36 | 🌐 CMake | 📅 2026-06-11 - Cross-platform package manager for C++.
