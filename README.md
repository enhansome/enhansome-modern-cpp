...
* [Folly](https://github.com/facebook/folly) ⭐ 30,543 | 🐛 480 | 🌐 C++ | 📅 2026-09-17 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,162 | 🐛 98 | 🌐 C++ | 📅 2026-09-17 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,548 | 🐛 506 | 🌐 C++ | 📅 2026-09-17 - Google Testing and Mocking Framework.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,608 | 🐛 54 | 🌐 C++ | 📅 2026-09-05 - Fast C++ logging library.
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,492 | 🐛 77 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,170 | 🐛 36 | 🌐 C++ | 📅 2026-09-14 - Modern C++ Parallel Task Programming Library
...
* [SPSCQueue](https://github.com/rigtorp/SPSCQueue) ⭐ 1,289 | 🐛 12 | 🌐 C++ | 📅 2024-01-04 - A bounded single-producer single-consumer wait-free and lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,625 | 🐛 106 | 🌐 C++ | 📅 2026-09-16 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,258 | 🐛 140 | 🌐 C++ | 📅 2026-09-17 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,150 | 🐛 27 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [Inja](https://github.com/pantor/inja) ⭐ 1,979 | 🐛 57 | 🌐 C++ | 📅 2026-09-10 - A Template Engine for Modern C++.
...
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,142 | 🐛 308 | 🌐 C++ | 📅 2025-03-07 - C++ library binding to Lua.
* [ChaiScript](https://chaiscript.com/) - An easy to use embedded scripting language for C++.

### Web / HTTP

* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,286 | 🐛 432 | 🌐 C++ | 📅 2026-09-16 - A C++14/17 based, high-performance HTTP application framework
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,433 | 🐛 88 | 🌐 C++ | 📅 2026-09-06 - C++ Requests: Curl for People, a spiritual port of Python Requests.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,695 | 🐛 18 | 🌐 C++ | 📅 2026-09-17 - powerful header only SQLite3 ORM library for C++14.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,107 | 🐛 2 | 🌐 C++ | 📅 2026-09-17 - C++ Driver for MongoDB.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,116 | 🐛 12 | 🌐 C++ | 📅 2026-09-17 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,203 | 🐛 16 | 🌐 C++ | 📅 2026-09-14 - Static reflection for enums (to string, from string, iteration) for modern C++, work with any enum type without any macro or boilerplate code.
* [cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,808 | 🐛 71 | 🌐 C++ | 📅 2026-09-17 -  Lightweight C++ command line option parser.
* [range-v3](https://github.com/ericniebler/range-v3) ⭐ 4,376 | 🐛 286 | 🌐 C++ | 📅 2026-04-12 - Experimental range library for C++11/14/17.
* [date](https://github.com/HowardHinnant/date) ⭐ 3,433 | 🐛 179 | 🌐 C++ | 📅 2026-09-16 - A date and time library based on the C++11/14/17 <chrono> header.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,467 | 🐛 1,123 | 🌐 CMake | 📅 2026-09-17 - C++ Library Manager for Windows, Linux, and MacOS
