...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,279 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,392 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for kick-starting modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management and more.
* [modern-cpp-template](https://github.com/filipdutescu/modern-cpp-template) ⭐ 1,917 | 🐛 12 | 🌐 CMake | 📅 2025-12-26 - A template for modern C++ projects using CMake, Clang-Format, CI, unit testing and more, with support for downstream inclusion.
* [cmake\_template](https://github.com/cpp-best-practices/cmake_template) ⭐ 1,804 | 🐛 45 | 🌐 CMake | 📅 2026-08-17 - A template CMake project to get you started with C++ and tooling.
* [Pitchfork](https://github.com/vector-of-bool/pitchfork) ⭐ 1,258 | 🐛 42 | 🌐 C++ | 📅 2024-04-26 - Pitchfork is a Set of C++ Project Conventions.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,513 | 🐛 463 | 🌐 C++ | 📅 2026-08-27 - Facebook Open-source Library.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,047 | 🐛 491 | 🌐 C++ | 📅 2026-08-27 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,448 | 🐛 438 | 🌐 C++ | 📅 2026-08-25 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [Approval Tests for C++](https://github.com/approvals/ApprovalTests.cpp) ⭐ 339 | 🐛 29 | 🌐 C++ | 📅 2026-08-27 - Native ApprovalTests for C++ on Linux, Mac and Windows.
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,372 | 🐛 174 | 🌐 C++ | 📅 2026-08-28 🌟 - A microbenchmark support library.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,534 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,470 | 🐛 77 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,130 | 🐛 34 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [json](https://github.com/nlohmann/json) ⭐ 50,470 | 🐛 143 | 🌐 C++ | 📅 2026-08-27 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,204 | 🐛 134 | 🌐 C++ | 📅 2026-08-27 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,133 | 🐛 28 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [json\_struct](https://github.com/jorgen/json_struct) ⭐ 473 | 🐛 3 | 🌐 C++ | 📅 2026-08-27 - High performance, single header JSON parser, parsing directly to and from C++ structs.
...
* [Inja](https://github.com/pantor/inja) ⭐ 1,963 | 🐛 55 | 🌐 C++ | 📅 2026-08-18 - A Template Engine for Modern C++.
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,009 | 🐛 716 | 🌐 C++ | 📅 2026-08-25 - Seamless operability between C++11 and Python.
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,130 | 🐛 308 | 🌐 C++ | 📅 2025-03-07 - C++ library binding to Lua.
* [ChaiScript](https://chaiscript.com/) - An easy to use embedded scripting language for C++.

### Web / HTTP

* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,220 | 🐛 420 | 🌐 C++ | 📅 2026-08-27 - A C++14/17 based, high-performance HTTP application framework
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,420 | 🐛 88 | 🌐 C++ | 📅 2026-07-26 - C++ Requests: Curl for People, a spiritual port of Python Requests.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,692 | 🐛 16 | 🌐 C++ | 📅 2026-08-27 - powerful header only SQLite3 ORM library for C++14.
...
* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,106 | 🐛 1 | 🌐 C++ | 📅 2026-08-27 - C++ Driver for MongoDB.
...
* [TinyORM](https://github.com/silverqx/TinyORM) ⭐ 354 | 🐛 15 | 🌐 C++ | 📅 2025-04-02 - Modern C++ ORM library.
...
* [date](https://github.com/HowardHinnant/date) ⭐ 3,430 | 🐛 179 | 🌐 C++ | 📅 2026-08-27 - A date and time library based on the C++11/14/17 <chrono> header.
...
* [tabulate](https://github.com/p-ranav/tabulate) ⭐ 2,175 | 🐛 44 | 🌐 C++ | 📅 2025-05-14 - Table Maker for Modern C++.
...
* [ccls](https://github.com/MaskRay/ccls) ⭐ 4,085 | 🐛 193 | 🌐 C++ | 📅 2026-07-02 - C/C++/ObjC language server supporting cross references, hierarchies, completion and semantic highlighting, forked from cquery, which is under active development
...
* [sanitizers](https://github.com/google/sanitizers) ⭐ 12,456 | 🐛 549 | 🌐 C | 📅 2026-05-19 🌟 - This project is the home for Sanitizers: AddressSanitizer, MemorySanitizer, ThreadSanitizer, LeakSanitizer, and more.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,402 | 🐛 1,203 | 🌐 CMake | 📅 2026-08-28 - C++ Library Manager for Windows, Linux, and MacOS
