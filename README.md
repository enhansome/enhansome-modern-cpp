...
[please submit a pull request to the GitHub repository](https://github.com/rigtorp/awesome-modern-cpp) ⭐ 13,137 | 🐛 20 | 🌐 HTML | 📅 2024-08-20.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,284 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [nanobench](https://github.com/martinus/nanobench) ⭐ 1,731 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 - Simple, fast, accurate single-header microbenchmarking functionality for C++11/14/17/20
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,540 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,471 | 🐛 77 | 🌐 C++ | 📅 2026-07-11 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11.
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,133 | 🐛 34 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,704 | 🐛 344 | 🌐 C++ | 📅 2026-03-11 - A C++11 library for serialization.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 510 | 🐛 15 | 🌐 C++ | 📅 2026-08-28 - Fast, convenient JSON serialization and parsing in C++
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 93 | 🌐 C++ | 📅 2026-08-24 - A JSON library with robust support for custom allocators.
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,420 | 🐛 86 | 🌐 C++ | 📅 2026-08-28 - C++ Requests: Curl for People, a spiritual port of Python Requests.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,692 | 🐛 16 | 🌐 C++ | 📅 2026-08-28 - powerful header only SQLite3 ORM library for C++14.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,057 | 🐛 11 | 🌐 C++ | 📅 2026-08-28 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
