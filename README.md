...
[please submit a pull request to the GitHub repository](https://github.com/rigtorp/awesome-modern-cpp) ⭐ 13,136 | 🐛 20 | 🌐 HTML | 📅 2024-08-20.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,286 | 🐛 246 | 🌐 CSS | 📅 2026-08-06 (Bjarne Stroustrup, Herb Sutter) \[C++11/14/17] - Guidelines for using modern C++.
...
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,393 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for kick-starting modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management and more.
...
* [Folly](https://github.com/facebook/folly) ⭐ 30,518 | 🐛 464 | 🌐 C++ | 📅 2026-08-29 - Facebook Open-source Library.
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,160 | 🐛 98 | 🌐 C++ | 📅 2026-08-29 - Modern C++17/20 framework to create console (CLI), forms (GUI like WinForms) and tunit (unit tests like Microsoft Unit Testing Framework) applications on Windows, macOS, Linux, iOS and android.
...
* [Googletest](https://github.com/google/googletest) ⭐ 39,295 | 🐛 494 | 🌐 C++ | 📅 2026-08-27 - Google Testing and Mocking Framework.
* [Catch](https://github.com/catchorg/Catch2) ⭐ 21,449 | 🐛 439 | 🌐 C++ | 📅 2026-08-25 🔥 - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD.
...
* [Mull](https://github.com/mull-project/mull) ⭐ 834 | 🐛 23 | 🌐 C++ | 📅 2026-07-31 - Practical mutation testing tool for C and C++
...
* [Google Benchmark](https://github.com/google/benchmark) ⭐ 10,375 | 🐛 174 | 🌐 C++ | 📅 2026-08-28 🌟 - A microbenchmark support library.
* [nanobench](https://github.com/martinus/nanobench) ⭐ 1,732 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 - Simple, fast, accurate single-header microbenchmarking functionality for C++11/14/17/20
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,542 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 - Fast C++ logging library.
...
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,132 | 🐛 34 | 🌐 C++ | 📅 2026-08-06 - Modern C++ Parallel Task Programming Library
...
* [Junction](https://github.com/preshing/junction) ⭐ 1,460 | 🐛 17 | 🌐 C++ | 📅 2026-05-16 - Concurrent data structures in C++.
* [SPSCQueue](https://github.com/rigtorp/SPSCQueue) ⭐ 1,281 | 🐛 11 | 🌐 C++ | 📅 2024-01-04 - A bounded single-producer single-consumer wait-free and lock-free queue written in C++11.
...
* [json](https://github.com/nlohmann/json) ⭐ 50,485 | 🐛 140 | 🌐 C++ | 📅 2026-08-28 🥇 - JSON for Modern C++.
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,214 | 🐛 134 | 🌐 C++ | 📅 2026-08-27 - Accelerate the parsing of JSON per se using commonly available SIMD instructions
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,134 | 🐛 28 | 🌐 C++ | 📅 2026-07-21 - A header-only C++17 library for parsing TOML v0.5.0 and later.
...
* [daw\_json\_link](https://github.com/beached/daw_json_link) ⭐ 510 | 🐛 15 | 🌐 C++ | 📅 2026-08-29 - Fast, convenient JSON serialization and parsing in C++
* [Boost.JSON](https://github.com/CPPAlliance/json) ⭐ 478 | 🐛 94 | 🌐 C++ | 📅 2026-08-24 - A JSON library with robust support for custom allocators.
* [json\_struct](https://github.com/jorgen/json_struct) ⭐ 474 | 🐛 6 | 🌐 C++ | 📅 2026-08-27 - High performance, single header JSON parser, parsing directly to and from C++ structs.
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,222 | 🐛 421 | 🌐 C++ | 📅 2026-08-27 - A C++14/17 based, high-performance HTTP application framework
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,422 | 🐛 86 | 🌐 C++ | 📅 2026-08-28 - C++ Requests: Curl for People, a spiritual port of Python Requests.
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,693 | 🐛 17 | 🌐 C++ | 📅 2026-08-29 - powerful header only SQLite3 ORM library for C++14.
...
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,059 | 🐛 11 | 🌐 C++ | 📅 2026-08-28 - A header-only, fast and, reliable entity-component system (ECS) for modern C++.
...
* [vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,404 | 🐛 1,218 | 🌐 CMake | 📅 2026-08-29 - C++ Library Manager for Windows, Linux, and MacOS
